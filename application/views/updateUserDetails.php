    ...
    <section class="content">
        <div class="row">
            <div class="col-sm-8">
                ...
                <?php
                    echo form_open_multipart(base_url('UpdateUserDetails'));
                ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text"  name="full_name" id="full_name" value=" <?php echo $user['full_name'] ?>" placeholder="Enter Name" /> 
                </div>
                <div class="form-group">
                    <label for="clinic_email"> Email :</label>
                    <input class="form-control" type="text" name="email" id="email" value=" <?php echo $user['email'] ?>" placeholder="Enter Email id" /> 
                </div>
                <div class="form-group">
                    <label for="clinic_office_no">Address :</label>
                    <input class="form-control"  type="text" name="address" id="address" value=" <?php echo $user['address'] ?>" placeholder="Enter Mobile No.">
                </div>

                <div class="form-group">
                    <label for="clinic_office_no">Date Of Birth :</label>
                    <input class="form-control"  type="text" name="date_of_birth" id="date_of_birth" value=" <?php echo $user['date_of_birth'] ?>" placeholder="Enter Mobile No.">
                </div>

                <div class="form-group">
                    <label for="clinic_office_no">Mobile Number :</label>
                    <input class="form-control"  type="text" name="mobile_no" id="mobile_no" value=" <?php echo $user['mobile_no'] ?>" placeholder="Enter Mobile No.">
                </div>
              
                <div class="form-group">
                    <label for="pin">Pincode :</label>
                    <input class="form-control"  type="text" name="pin" value=" <?php echo $user['pin'] ?>"id="pin" placeholder="Enter Pincode" /> 
                </div>
                ...
                <div class="form-group col-md-12">
                    <button type="submit" id="clinic_add" class="btn btn-default" >Update User</button>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
